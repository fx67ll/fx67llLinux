...
## 0.2.6.20260806
* 部署`Fail2ban`服务器安全防护  
* 新增`Fail2ban-recidive监狱`的惯犯永久封禁机制  
* 更新博文：服务器入侵应急响应与安全加固全指南（已完成发布）  
* 更新博文：Fail2Ban 防护部署与运维手册（已完成发布）  

## 0.2.5.20260730
* 更新`nginx`全套端口代理配置  
* 新增 877 端口`nginx`代理配置  
* 新增**AI 优化版**`nginx`配置目录  

## 0.2.4.20260725
* 更新多个项目的`jenkins`自动化部署`shell`脚本  
