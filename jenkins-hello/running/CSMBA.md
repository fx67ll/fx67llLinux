...
cd /usr/share/nginx/html-79  
ls  
rm -rf *  
ls  
cd /root/.jenkins/workspace/CSMBA/unpackage/dist/build/h5  
scp /root/.jenkins/workspace/CSMBA/unpackage/dist/build/h5/dist.tar.gz /usr/share/nginx/html-79  
rm -R ./dist.tar.gz  
cd /usr/share/nginx/html-79  
...
### `CSMBA`在`github`中用的`Personal access tokens`是`jenkins-token`  
