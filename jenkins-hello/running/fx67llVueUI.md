...
rm -rf *
ls
cd /root/.jenkins/workspace/$PROJECT_NAME/.vuepress/dist
scp /root/.jenkins/workspace/$PROJECT_NAME/.vuepress/dist/dist.tar.gz /usr/share/nginx/html-$PROJECT_PORT
rm -R ./dist.tar.gz
cd /usr/share/nginx/html-$PROJECT_PORT
tar -zxvf dist.tar.gz -C ./
rm -R dist.tar.gz  
...
PROJECT_NAME=fx67llVueUI
PROJECT_PORT=89
PROJECT_FILE_PATH=.vuepress/dist
echo "本次编译项目名称：$PROJECT_NAME，项目编号：$PROJECT_PORT"
